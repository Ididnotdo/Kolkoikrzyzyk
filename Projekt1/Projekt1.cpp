...
{
	al_clear_to_color(al_map_rgb(175, 112, 104));
	al_draw_text(font, linie, 300, 300, ALLEGRO_ALIGN_CENTER, "Ha ha ha ha");
	al_flip_display();
...
{
	al_clear_to_color(al_map_rgb(175, 112, 104));
	al_draw_text(font, linie, 300, 300, ALLEGRO_ALIGN_CENTER, "Musiales oszukac...");
	al_flip_display();
...
{
	al_clear_to_color(al_map_rgb(175, 112, 104));
	al_draw_text(font, linie, 300, 300, ALLEGRO_ALIGN_CENTER, "Pfft... nie umiesz wygrac");
	al_flip_display();
